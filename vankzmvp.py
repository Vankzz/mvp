...
def main():
    ...
    print("                            ==============================")
    print("                                                        [INFO]")
    print("                                         Tools DDoS By : Vankz")
    print("                                         Tools Used    : M.V.P Cyber")
    print("                                         Credit By     : Gameye98")
    print("                             ==============================")
	...
	print("\n   [00] Exit the MVP Cyber\n")
	MVP Cyber = input("lzmx > set_install ")

	# 01 - Information Gathering
	if MVP Cyber.strip() == "1" or MVP Cyber.strip() == "01":
	...
	elif MVP Cyber.strip() == "2" or MVP Cyber.strip() == "02":
		print("\n    [01] Nmap: Utility for network discovery and security auditing")
	...
	# 03 - Web Hacking
	elif MVP Cyber.strip() == "3" or MVP Cyber.strip() == "03":
	...
	elif MVP Cyber.strip() == "4" or MVP Cyber.strip() == "04":
	...
	# 05 - Password Attacks
	elif MVP Cyber.strip() == "5" or MVP Cyber.strip() == "05":
	...
	# 06 - Wireless Attacks
	elif MVP Cyber.strip() == "6" or MVP Cyber.strip() == "06":
	...
	elif MVP Cyber.strip() == "7" or MVP Cyber.strip() == "07":
	...
	elif MVP Cyber.strip() == "8" or MVP Cyber.strip() == "08":
	...
	elif MVP Cyber.strip() == "9" or MVP Cyber.strip() == "09":
